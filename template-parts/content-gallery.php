...
?>
<?php $post_class_sticky = 'blog-post wow fadeInUpBig animated sticky-post'?>
<div <?php if (is_sticky()) { wp_kses_post(post_class($post_class_sticky));
  } else {wp_kses_post(post_class('blog-post wow fadeInUpBig animated'));}
 ?> id="post-<?php the_ID(); ?>">
    ...
    <div class="button-style-6">
      <a href="<?php the_permalink(); ?>" class="b-md butt-style"><?php echo esc_html__('read more','nrg_premium') ?></a>  
    </div>
</div>
